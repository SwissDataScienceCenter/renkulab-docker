...
describe('Test jupyter notebook', () => {
  ...
  it("Can run terminal command to create a file", jupyterlabTestFuncs.makeFileWithTerminal("new-file.txt"))
  it("Can remove the file", jupyterlabTestFuncs.removeFileWithTerminal("new-file.txt"))
  it("Can close the terminal", jupyterlabTestFuncs.closeTerminal)
  it('Can find expected start page elements again', jupyterlabTestFuncs.findExpectedElements)
})